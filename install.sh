...
cd $GOPATH/src/github.com/georzaza/go-ethereum-v0.7.10_official
git checkout $branch
...
#echo "go get -u -d github.com/georzaza/go-ethereum-v0.7.10_official/$path"
#go get -v -u -d github.com/georzaza/go-ethereum-v0.7.10_official/$path
#if [ $? != 0 ]; then
#	echo "go get failed"
#	exit
#fi

cd $GOPATH/src/github.com/georzaza/go-ethereum-v0.7.10_official/$path

if [ "$exe" == "mist" ]; then
	echo "Building Mist GUI. Assuming Qt is installed. If this step"
	echo "fails; please refer to: https://github.com/georzaza/go-ethereum-v0.7.10_official/wiki/Building-Ethereum(Go)"
else
